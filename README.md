NiyoTaskManagerAPI is a RESTful API for a simple task management system inclusive of an API developed with Nodejs(express framework) and realtime data streaming capacity
with stream.io  
